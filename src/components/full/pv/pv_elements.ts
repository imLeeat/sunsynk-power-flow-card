...
export const renderSolarElements = (
	...
	return html`
		...
		<svg
			...
			y="2.5%"
		>
			${renderPV('pvtotal-wide', '177', '230', data, config)}
			${renderPV('pvtotal-small', '51', '162', data, config)}
			...
			${renderText(
				...
				0,
				168.5,
				[1, 2, 3, 4].includes(mppts) || !config.wide,
				'st3 st8 left-align',
				solarColour,
			...
			${renderText(
				...
				99,
				168.5,
				[1, 2, 3, 4, 5].includes(mppts) || !config.wide,
				'st3 st8 left-align',
				solarColour,
			...
			${renderText(
				...
				0,
				213.5,
				[1, 2, 3, 4, 5, 6].includes(mppts) || !config.wide,
				'st3 st8 left-align',
				solarColour,
			...
			${renderText(
				...
				99,
				213.5,
				[1, 2, 3, 4, 5, 6, 7].includes(mppts) || !config.wide,
				'st3 st8 left-align',
				solarColour,
			...
			${renderPVFlow(
				...
				mppts === 1
					? config.wide
						? 'M 278 250 L 96 250 Q 86 250 86 240 L 86 66 Q 86 56 76 56 H 70'
						: 'M 155 250 L 96 250 Q 86 250 86 240 L 86 66 Q 86 56 76 56 H 70'
					: config.wide
						? 'M 86 212 L 86 56 H 70'
						: 'M 86 162 L 86 56 H 70',
				solarColour,
				data.pv1LineWidth,
				data.pv1PowerWatts,
				durationCur['pv1'],
			...
			${renderPVFlow(
				...
				config.wide
					...
					: 'M 86 162 L 86 101 Q 86 101 86 101 L 70 101',
				solarColour,
				data.pv3LineWidth,
				data.pv3PowerWatts,
				durationCur['pv3'],
			...
			${renderPVFlow(
				...
				config.wide
					...
					: 'M 86 162 L 86 101 Q 86 101 86 101 L 101 101',
				solarColour,
				data.pv4LineWidth,
				data.pv4PowerWatts,
				durationCur['pv4'],
			...
			${renderPVFlow(
				...
				invert_flow,
				minLineWidth,
				[1, 2, 3, 4].includes(mppts) || !config.wide ? 'st12' : '',
				'1;0',
			)}
			${renderPVFlow(
				'pv6',
				...
				invert_flow,
				minLineWidth,
				[1, 2, 3, 4, 5].includes(mppts) || !config.wide ? 'st12' : '',
				'1;0',
			)}
			${renderPVFlow(
				'pv7',
				...
				invert_flow,
				minLineWidth,
				[1, 2, 3, 4, 5, 6].includes(mppts) || !config.wide ? 'st12' : '',
				'1;0',
			)}
			${renderPVFlow(
				'pv8',
				...
				invert_flow,
				minLineWidth,
				[1, 2, 3, 4, 5, 6, 7].includes(mppts) || !config.wide ? 'st12' : '',
				'1;0',
			)}
			${renderPVFlow(
				'solar1',
